...
from satellite_tiles_t17 import MyDataset
...
for rt in [0,90,180,270]:
    for r in [0,1,2]:
        for d in [0,1,2]:
            data_dir.append(f'./urban_data/Descriptions_s2/NewYork_4lu_grid_rt{rt}_r{r}_d{d}.csv')

gpu_no = 5
ck_output_file = './ckpts/checkpoints_t17'
