...
class MyDataset(Dataset):
    def __init__(self, image_dir, data_dir, hint_dir):
        ...
        self.description = self.description['descriptions'].to_list()
    ...
    def __getitem__(self, item):
        ...
        hint_name = self.image_dir + city + '_Stage_2_' + r + '_' + d + '/' + str(xtile) + '_' + str(ytile) + '_' + r + '_' + d + '.tif'
        img_name =  self.image_dir + city + '_Stage_3_' + r + '_' + d + '/' + str(xtile) + '_' + str(ytile) + '_' + r + '_' + d + '.tif'     
